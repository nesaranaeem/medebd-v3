...
const AboutPage = () => {
  return (
    <>
      <NextSeo
        title="About"
        description="Welcome to medebd.com, your one-stop destination for all things healthcare in Bangladesh. We are proud to offer the most comprehensive and up-to-date directory of medicine brands, doctors, and hospitals in the country."
      />
      <div>
        <section>
              ...
              <div className="lg:py-16">
                <article className="space-y-4 text-gray-700">
                  ...
                  <p>
                    ...
                    making that a reality. Whether you are a patient, a
                  ...
                  <p>
                    ...
                    suggestions or feedback, please do not hesitate to
